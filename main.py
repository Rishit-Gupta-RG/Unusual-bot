...
async def play(ctx,url):
    ...
    if not ctx.message.author.id==787149777103486986:
         await ctx.send('<:_:919194636906561548> **This command is under Testing phase!**, Only bot dev. can use this command at the moment.')
         return
    try :
